...
public class UI {
    ...
    public UI(GamePanel gp) {
        this.gp = gp;
        try {
            InputStream is = getClass().getResourceAsStream("/font/VigranMaroll-2OzWK.otf");
            vigranMarol = Font.createFont(Font.TRUETYPE_FONT, is);
            is = getClass().getResourceAsStream("/font/04B_30__.TTF");
    ...
    public void drawTitleScreen() {
        ...
        if (titleScreenState == 0) {
            ...
            String text = "Leprechaun adventure";
    ...
    public void drawCharacterScreen() {
        ...
        textY += lineHeight;
        g2.drawString("Next Level 1", textX, textY);
        textY += lineHeight;
    ...
    public void options_control(int frameX, int frameY) {
        ...
        g2.drawString("QSDZ", textX, textY);
        textY += gp.tileSize;
        ...
        if (itemIndex < npc.inventory.size()) {
            ...
            if (gp.keyH.enterPressed) {
                if (npc.inventory.get(itemIndex).price > gp.player.coin) {
                    ...
                    if(gp.player.canOptainItem(npc.inventory.get(itemIndex))){
